  ...
  <div className="relative w-full px-4 flex items-center justify-center">
    ...
    <div className="relative w-full aspect-[3/4] md:aspect-[2/3] max-h-[90vh] hidden md:block">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(145deg, rgba(59, 130, 246, 0.08), rgba(147, 51, 234, 0.08))",
          boxShadow: "0 0 40px rgba(59, 130, 246, 0.2), inset 0 0 15px rgba(255, 255, 255, 0.05)",
        }}
      >
